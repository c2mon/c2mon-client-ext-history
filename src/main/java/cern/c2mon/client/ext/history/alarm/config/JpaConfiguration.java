 ...
 * be used under the hood by our {@link AlarmService}.
 *
...
public class JpaConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("historyDataSource") DataSource dataSource) {
    ...
    Map<String, String> propertyMap = new Hashtable<>();
    propertyMap.put("javax.persistence.validation.mode", "none");
    // If not set, the alarm timestamp does not get correctly converted into the local time zone and vice versa
    propertyMap.put("hibernate.jdbc.time_zone", "UTC");
